  ...
  *         The evented object we are validating for
  ...
  class TimeTooltip extends Component {
    ...
    update(seekBarRect, seekBarPoint, content) {
      ...
      const timeTooltipWidth = parseFloat(computedStyle(this.el(), 'width'));
      ...
      if (timeTooltipPosition >= timeTooltipWidth && timeTooltipPosition <= seekBarRectWidth && this.el().style.length || isSeekBarSmallerThanTimeTooltip) {
        this.el().style = '';
        return;
      }
